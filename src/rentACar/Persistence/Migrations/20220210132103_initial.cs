        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentKilometer = table.Column<double>(type: "float", nullable: false),
                    ReturnKilometer = table.Column<double>(type: "float", nullable: false),
                    CarId = table.Column<int>(type: "int", nullable: false),
                    CustomerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1000.0, 1, "https://images.pexels.com/photos/170811/pexels-photo-170811.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500", "418i", 2 });
            ...
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "State", "ColorId", "FindexScore", "ModelId", "ModelYear", "Plate" },
                values: new object[] { 1, 1, 1, 1750, 1, (short)2018, "06ABC06" });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "State", "ColorId", "FindexScore", "ModelId", "ModelYear", "Plate" },
                values: new object[] { 2, 1, 2, 1520, 2, (short)2018, "34ABC34" });
